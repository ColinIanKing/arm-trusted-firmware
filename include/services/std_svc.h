...
#if SPCI_SUPPORT
#define SMCCC_PCI_VERSION		U(0x84000130)
#define SMCCC_PCI_FEATURES		U(0x84000131)
#define SMCCC_PCI_READ			U(0x84000132)
#define SMCCC_PCI_WRITE			U(0x84000133)
#define SMCCC_PCI_SEG_INFO		U(0x84000134)
